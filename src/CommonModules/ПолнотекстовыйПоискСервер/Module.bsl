...
Процедура ОбновлениеИндексаППДПоРасписанию() Экспорт
	...
	//В кончигурации используется рег задание ОбновлениеИндексаПолнотекстовогоПоиска
	ВызватьИсключение "Не используется. Обратитесь к администратору.";
...
Функция ВыполняетсяФоновоеЗаданиеОбновлениеИндекса()
	...
	РегламентноеЗадание = Метаданные.РегламентныеЗадания.ОбновлениеИндексаПолнотекстовогоПоиска;
...
Процедура ЗаписьЖурнала(
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'Полнотекстовое индексирование'",  Метаданные.ОсновнойЯзык.КодЯзыка),//ОбщегоНазначения.КодОсновногоЯзыка()), 
		УровеньЖурнала, , , 
		ТекстДляЖурнала);
