...
// Отправляет транспортные контейнеры через оператора электронного документооборота.
// 
// Параметры:
...
// 	ПовторнаяОтправка - Булево - необходимо установить в Истину, если запрос выполняется повторно в рамках одной
...
Функция ОтправитьТранспортныеКонтейнеры(Контейнеры, КлючиСинхронизации, КонтекстДиагностики,
	РезультатыОтправкиПолучения, ПовторнаяОтправка = Ложь, ДополнительныеПараметры = Неопределено) Экспорт
	
	Возврат СинхронизацияЭДОСлужебный.ОтправитьТранспортныеКонтейнеры(Контейнеры, КлючиСинхронизации,
		КонтекстДиагностики, РезультатыОтправкиПолучения, ПовторнаяОтправка, ДополнительныеПараметры);
...
Функция НовыеДанныеОбъектов() Экспорт
	...
	ДанныеОбъектов.Колонки.Добавить("Контрагент", Метаданные.ОпределяемыеТипы.КонтрагентБЭД.Тип);
...
// * ОповещенОСрокеДействия - Булево - пользователь оповещен о скором окончании
...
Функция НовыеДанныеСертификата() Экспорт
	...
	ДанныеСертификата.Вставить("ОповещенОСрокеДействия", Ложь);
