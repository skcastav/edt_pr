...
Процедура УдалитьРегламентноеЗадание(Отказ)
	...
	РегламентноеЗаданиеОбъект = СРМ_ОбменВебСервис.НайтиРегламентноеЗаданиеПоПараметру(РегламентноеЗаданиеGUID);
	//
	Если РегламентноеЗаданиеОбъект <> Неопределено Тогда
		...
		Исключение
			СтрокаСообщения = НСтр("en='Error when deleting the scheduled task: %1';ru='Ошибка при удалении регламентного задания: %1'");
